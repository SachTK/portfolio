    ...
    <div id='main' className='bg-radial-at-r to-indigo-900 w-full h-screen bg-[#0a192f] '>
      ...
      <div className='w-full h-screen absolute top-0 left-0'>
        <div className='max-w-[700px] m-auto h-full w-full flex flex-col justify-center lg:items-start items-center'>
          <h1 className='text-8xl font-bold text-white'>Hi, I'm </h1>
          <h1 className='text-7xl font-bold text-white'>Sachini Kandambige </h1>
          <h2 className='flex sm:text-xl text-4xl pt-5 text-sky-400'>
            <TypeAnimation
              sequence={[
                'Developer',
                2000,
              ...
              wrapper="div"
              speed={50}
              style={{ fontSize: '2em', paddingLeft: '5px', display: 'inline-block' }}
              repeat={Infinity}
              cursor={true}
            />
          </h2>
